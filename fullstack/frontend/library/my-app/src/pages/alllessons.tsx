...
import { SocialMediaSharing } from "../components/reactshare/SocialMediaSharing";
import { MyProps } from "../components/props/MyProps";
import { MYuseEffect } from "../components/hook/MyuseEffect";
...
export const AllLEssons:React.FC<{}>=()=>{
    ...
    return  <Box >
      ...
      <TabContext value={`${val}`}>
        ...
        <TabPanel value={"1"}><MyHook/></TabPanel>
        <TabPanel value="2"><SocialMediaSharing/></TabPanel>
        <TabPanel value="3">&lt; and &gt;</TabPanel>
        <TabPanel value="4"><MyProps/></TabPanel>
        <TabPanel value="5"><MYuseEffect/></TabPanel>
      </TabContext>
    </Box>
